...
$l['user_email_log_desc'] = 'Все письма, отправленные от одного участника к другому участнику, а также письма , отправленные функцией "Отправить тему другу \'регистрируются и показаны ниже. Здесь вы можете определить потенциально злоупотребляющих этой функции.';
$l['prune_user_email_log'] = 'Очистить журнал Email пользователей';
$l['close_window'] = 'Закрыть окно';
$l['user_email_log_viewer'] = 'Просомотр журнала Email пользователей';
$l['to'] = 'Кому';
$l['from'] = 'От';
