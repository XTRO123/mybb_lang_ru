...
$l['success_ban_lifted'] = 'Выбранный запрет был успешно lifted.';
...
$l['confirm_lift_ban'] = 'Вы уверены, что хотите lift этот бан?';
...
$l['na'] = 'Н/Д';
$l['for'] = 'для';
$l['bannedby_x_on_x'] = '<strong>{1}</strong><br /><small>Забанен {2} - {3} {4}</small>';
$l['lift'] = 'lift';
