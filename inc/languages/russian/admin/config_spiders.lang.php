...
$l['spiders_bots_desc'] = 'Этот раздел позволяет управлять пауками поисковых систем; ботов, которые автоматически распознаются на форуме. Вы также можете видеть, когда в последний раз посетил конкретный бот.';
...
$l['use_board_default'] = 'Использовать форумы по умолчанию';
