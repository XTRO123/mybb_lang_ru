...
$l['forum_announcements_desc'] = 'Здесь вы можете управлять объявлениями на форумах. Эти объявления показываются на всех форумах, в то время как некоторые установленны для отдельных форумов и представлены на этом форуме и всех дочерних форумах.';
...
$l['start_date_desc'] = 'В эту дату и временя (по Гринвичу), объявление появится в выбранном форуме (ах).';
$l['end_date_desc'] = 'В эту дату и временя (по Гринвичу), объявление будет скрыто от просмотра на вашем форуме. Вы можете выбрать не окончание этого объявления, а пока вы не удалите его или изменить дату его окончания.';
