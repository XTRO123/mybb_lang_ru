...
$l['user_titles_desc'] = 'Этот раздел позволяет управлять званиями пользователей. Звания пользователей назначаются пользователям на основе количества сообщений, которые они делают, а также позволяют показывать изображение \'Звезда\' на основе числе сообщений пользователя.';
$l['add_new_user_title'] = 'Довать новое звание пользователя';
...
$l['star_image_desc'] = 'Если это звание пользователя должно показывать звезды, введите здесь путь к изображения звезды. Если пусто, будет показано изображение звезды группы пользователей . Используйте {theme} чтобы указать директорию изображений для просмотра в текущей теме.';
